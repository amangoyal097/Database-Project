...
INSERT INTO `BANKINTEREST` VALUES ('Bank of China',6.70),('Bank Sepah International PLC',13.50),('Barclays Bank',5.60),('Deutsche Bank',4.70),('Handelsbanken London',11.30),('Metro Bank',10.00),('TurkishBank UK',9.90),('Union Bank of India (UK) Ltd',12.50);
...
INSERT INTO `CITYTOSTATE` VALUES ('Punjab','Amritsar'),('Punjab','Barnala'),('Telangana','Hyderbad'),('Rajasthan','Jaipur'),('Maharashtra','Mumbai'),('Bihar','Patna'),('Maharashtra','Pune'),('Kerala','Thiruvanthpuram');
...
INSERT INTO `COMMERCIAL` VALUES (2,'Godown',0,2011,2),(1,'shop',40,2000,3),(4,'Office',3000,2010,7),(10,'Office',3000,2014,10);
...
INSERT INTO `DEPENDENT` VALUES (35,'Eshan Gupta',9,'Male','Friend'),(65,'Keshav Bajaj',5,'Male','Uncle'),(45,'Mayank Goel',1,'Male','Uncle');
...
INSERT INTO `PERSON` VALUES (1,'Modi','Male','Software Engineer','Well built'),(2,'Tanvi','Female','Businessman','Looked fondly to my time there'),(3,'Shradha','Female','Doctor','The place was a mess'),(6,'Arun','Male','Doctor','happy to live there, Great view, '),(8,'Yash','Male','Transponster','happy to live there'),(9,'Amit','Male','Housewife','happy to live there');
...
INSERT INTO `PINCODETOCITY` VALUES ('148101','Barnala'),('300598','Jaipur'),('324005','Hyderabad'),('328895','Thiruvanthpuram'),('654879','Amritsar'),('800001','Patna'),('800015','Patna'),('920008','Pune'),('920045','Pune'),('968004','Mumbai');
...
INSERT INTO `PROPERTY` VALUES (2,'143 B','Real Dad Road','2020-10-04','South',694200,1),(3,'8283 C3','Amar Corner, Hadapsar','1970-10-21','North',4206815,2),(4,'09820','Govind Puri, Kalkaji','2000-03-17','South',9867424,3),(1,'46','Bombay Talkies Compound, Malad','2004-12-12','West',287454,4),(5,'Plot No.58/c','Kattedan','1984-07-25','East',9834825,5),(7,'11 B','Canal Street','2012-09-19','North',489300,6),(8,'29 G','Conventery Street','2011-07-12','East',758400,7),(9,'37 H','Maiden Lane','2009-07-01','East',398600,8),(10,'2012','Houston Street','2019-08-09','South',934700,9),(6,'BXI/748','Dalal Street','2018-11-13','West',561200,10);
...
CREATE TABLE `PROPERTYDEAL` (
  ...
  CONSTRAINT `PROPERTYDEAL_ibfk_1` FOREIGN KEY (`BuyerID`) REFERENCES `BUYER` (`BuyerID`),
  CONSTRAINT `PROPERTYDEAL_ibfk_2` FOREIGN KEY (`SellerID`) REFERENCES `SELLER` (`SellerID`),
  CONSTRAINT `PROPERTYDEAL_ibfk_3` FOREIGN KEY (`AgentID`) REFERENCES `AGENT` (`AgentID`),
  CONSTRAINT `PROPERTYDEAL_ibfk_4` FOREIGN KEY (`PropertyID`) REFERENCES `PROPERTY` (`PropertyID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `PROPERTY_DEAL`
--

DROP TABLE IF EXISTS `PROPERTY_DEAL`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `PROPERTY_DEAL` (
  ...
  KEY `AgentID` (`AgentID`),
  KEY `PropertyID` (`PropertyID`),
  CONSTRAINT `PROPERTY_DEAL_ibfk_1` FOREIGN KEY (`BuyerID`) REFERENCES `BUYER` (`BuyerID`),
  CONSTRAINT `PROPERTY_DEAL_ibfk_2` FOREIGN KEY (`SellerID`) REFERENCES `SELLER` (`SellerID`),
  CONSTRAINT `PROPERTY_DEAL_ibfk_3` FOREIGN KEY (`AgentID`) REFERENCES `AGENT` (`AgentID`),
  CONSTRAINT `PROPERTY_DEAL_ibfk_4` FOREIGN KEY (`PropertyID`) REFERENCES `PROPERTY` (`PropertyID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `PROPERTY_DEAL`
--

LOCK TABLES `PROPERTY_DEAL` WRITE;
/*!40000 ALTER TABLE `PROPERTY_DEAL` DISABLE KEYS */;
/*!40000 ALTER TABLE `PROPERTY_DEAL` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `RESIDENTIAL` VALUES (18,24,250,'No','villa',3,2,6),(19,24,200,'No','villa',3,2,8),(24,22,150,'Yes','flat',1,1,9);
...
CREATE TABLE `SERVICES` (
  ...
  CONSTRAINT `SERVICES_ibfk_1` FOREIGN KEY (`PropertyID`) REFERENCES `COMMERCIAL` (`PropertyID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `SERVICES` VALUES (2,'Youthful community, constant water and electricity supplies'),(3,'Atm, supermarket and railway station available nearby'),(7,'Near by airport'),(10,'Park and stadium near by');
...
INSERT INTO `STREETTOPINCODE` VALUES ('324005','Amar Corner, Hadapsar'),('148101','Bombay Talkies Compound, Malad'),('328895','Canal Street'),('920008','Conventry Street'),('800015','Dalal Street'),('968004','Govind Puri, Kalkaji'),('920045','Houston Street'),('654879','Kattedan'),('300598','Maiden Lane'),('800001','Real Dad Road');
...
-- Dump completed on 2020-10-05 12:26:49
